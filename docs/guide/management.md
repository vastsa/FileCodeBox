...
<p align="center">
  <img src="/screenshots/login.webp" alt="管理登录" width="640" />
</p>
...
1. 首次访问站点时，按初始化页面设置管理员密码
2. 在浏览器中访问 `http://your-domain.com/admin`
3. 输入管理员密码（`admin_token` 配置项的值）
4. 点击登录按钮

::: tip 提示
未初始化时会自动进入初始化页面。生产环境请先完成初始化，再开放公网访问。
:::
...
<p align="center">
  <img src="/screenshots/dashboard.webp" alt="管理仪表盘" width="860" />
</p>
...
<p align="center">
  <img src="/screenshots/files.webp" alt="文件管理" width="860" />
</p>
...
<p align="center">
  <img src="/screenshots/settings.webp" alt="系统设置" width="860" />
</p>
